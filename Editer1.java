...
public class Editer1 extends JFrame implements ActionListener,KeyListener
{
    JFrame jf;
    JMenuBar mb;
            ...
            try
            {
                ...
                else if(ae.getActionCommand().equals("Compile"))
                {
                    if(!filename.equals(""))
                    {
                        try {
                            result="";
                            Process error=r.exec("C:\\Program Files\\Java\\jdk-22\\bin\\javac.exe"+filename);
                ...
                else if(ae.getActionCommand().equals("Run..."))
                {
                    ...
                    if (!fname.equals("")) {
                        try {
                            ...
                            Process p=r.exec("C:\\Program Files\\Java\\jdk-22\\bin\\javac.exe -cp . "+fn);
